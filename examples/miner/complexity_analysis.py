...
def as_csv(stats):
# print('n,total,mean,sd,max,lineDiffComplex')
 fields_of_interest = [args.file, stats.n_revs, stats.total, round(stats.mean(),2), round(stats.sd(),2), stats.max_value(), stats.lineDiffComplexity()]
